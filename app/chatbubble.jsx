    ...
    <div className="" ref={chatBubbleRef}>
      ...
      <div 
        className={`
          ...
          flex flex-col justify-center items-start gap-1 sm:gap-2
          px-[15px] py-[10px] sm:px-[27px] sm:py-[14px]
      ...
      >
        <p className="text-sm sm:text-base bg-gradient-to-r from-[#d4f0fc] to-[#02a9f7] text-transparent bg-clip-text font-medium">SEN</p>
